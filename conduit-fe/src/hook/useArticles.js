...
const useArticles = (refreshArticles) => {
    ...
    const [apiErrors, setApiErrors] = useState([]); // Lưu lỗi từ API
    const [tags, setTags] = useState([]); // State lưu tags
    ...
    const onSubmitArticles = async (data) => {
        try {
